<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('يمكنك إدارة جلساتك النشطة وتسجيل خروجها على المتصفحات والأجهزة الأخرى.') }}
    </x-slot>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <div class="text-sm text-gray-600">
                                {{ $session->agent->platform() ? $session->agent->platform() : 'غير معروف' }} - {{ $session->agent->browser() ? $session->agent->browser() : 'Unknown' }}
                            </div>
