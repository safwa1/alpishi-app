...
{{--                     class="menu-item flex items-center w-full px-6 py-3  border-b border-gray-100/60 text-sm text-neutral-400 gap-6"--}}
{{--                     :class="{'border-b-0': item.id === items.length, 'text-primary': {!! request()->routeIs(item.route.name) !!} }">--}}
{{--                    <div x-html="item.icon"></div>--}}
{{--                    <span x-text="item.title"></span>--}}
{{--                </div>--}}
{{--            </a>--}}
{{--        </template>--}}
        <x-menu.mobile.menu-item href="{{route('home')}}" :active="request()->routeIs('home')" :is-last="false">
            <x-slot name="icon">
        ...
        <x-menu.mobile.menu-item href="{{route('about')}}" :active="request()->routeIs('about')" :is-last="false">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <x-menu.mobile.menu-item href="{{route('purchase-methods')}}" :active="request()->routeIs('purchase-methods')" :is-last="false">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <x-menu.mobile.menu-item href="{{route('contactus')}}" :active="request()->routeIs('contactus')" :is-last="true">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <x-menu.mobile.menu-item href="{{route('auction')}}" :active="request()->routeIs('auction')" :is-last="true">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
