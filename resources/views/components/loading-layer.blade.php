@php
    $classes = 'fixed inset-0 w-full h-full flex justify-center items-center bg-white opacity-60 backdrop-blur-sm z-30 overflow-hidden';
@endphp
...
<div {{ $attributes->merge(['class' => $classes]) }}>
    <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
            <filter id="ldio-w8y33u10a-filter" x="-100%" y="-100%" width="300%" height="300%"
        ...
        <g filter="url(#ldio-w8y33u10a-filter)">
